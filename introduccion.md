...
## Resultados de aprendizaje oficiales (RA 1-8)

<div style="font-size: 1.05rem; text-align: left;">

El módulo 0488 se organiza en torno a ocho RA (RD 405/2023):
</div>

<div style="text-align: left;">
<span class="fragment" style="font-size: 1.5rem;"><mark>RA 1.</mark> Genera interfaces gráficos mediante editores visuales y adaptando el código generado</span>

<span class="fragment" style="font-size: 1.5rem;"><mark>RA 2.</mark> Genera interfaces naturales de usuario (voz, cuerpo, RA)</span>

<span class="fragment" style="font-size: 1.5rem;"><mark>RA 3.</mark> Crea componentes visuales</span>

<span class="fragment" style="font-size: 1.5rem;"><mark>RA 4.</mark> Diseña interfaces gráficas con criterios de usabilidad y accesibilidad</span>
</div>

Note:
Estos ocho resultados de aprendizaje son los que evalúa el currículo oficial. Cada unidad del módulo trabaja uno o varios RA; en las diapositivas de cada unidad veréis su alineación concreta con los criterios de evaluación.
...
<div style="text-align: left;">
<span class="fragment" style="font-size: 1.5rem;"><mark>RA 5.</mark> Crea informes con herramientas gráficas</span>

<span class="fragment" style="font-size: 1.5rem;"><mark>RA 6.</mark> Documenta aplicaciones</span>

<span class="fragment" style="font-size: 1.5rem;"><mark>RA 7.</mark> Prepara aplicaciones para su distribución</span>

<span class="fragment" style="font-size: 1.5rem;"><mark>RA 8.</mark> Evalúa el funcionamiento mediante pruebas</span>
</div>
...
## Mapa de cobertura por unidades
...
| **RA 2** | U3 (interfaces naturales) |
| **RA 3** | U7 · U10 · U11 · U13 · U14 · U15 (componentes visuales) |
| **RA 4** | U1 (UX) · U2 (accesibilidad) · U4 · U5 · U6 · U8 · U17 |
| **RA 5** | U16 (informes) · U17 (dashboards) |
| **RA 6** | U14 (documentación de componentes) · U18 (documentación) |
| **RA 7** | U20 (Electron) · U21 (empaquetado y distribución) |
| **RA 8** | U19 (pruebas de software) |

</div>
Note:
Esta tabla es el mapa del módulo: cada RA tiene su unidad principal. Los RAs con varias unidades se trabajan de forma progresiva (p. ej., RA 3 aparece desde componentes hasta la implementación completa en U15). Usadla para situar dónde se evalúa cada resultado.
...
<div class="fragment">
<strong>Neuromorfismo</strong><br>
Sombras suaves, efecto plástico. <br>⚠️ Bajo contraste → problemas de accesibilidad
</div>
<div class="fragment">
<img src="./img/00/Neumorfismo.png" alt="Neuromorfismo" style="max-width: 100%; max-height: 32vh; object-fit: contain; border-radius: 8px;">
</div>
</div>
...
<div class="fragment">
<strong>Glassmorfismo</strong><br>
<code>backdrop-filter: blur()</code>, fondos translúcidos. Windows 11, macOS.
</div>
<div class="fragment">
<img src="./img/00/Glassmorfismo.jpeg" alt="Glassmorfismo" style="max-width: 100%; max-height: 32vh; object-fit: contain; border-radius: 8px;">
</div>
</div>
...
<div class="fragment">
<img src="./img/00/Minimalismo.avif" alt="Minimalismo" style="max-width: 100%; max-height: 32vh; object-fit: contain; border-radius: 8px;">
</div>
</div>
...
<div class="fragment">
<strong>Brutalismo</strong><br>
Tipografía grande sin adornos, colores planos y vibrantes, bordes duros, falta de sutileza.
</div>
<div class="fragment">
<img src="./img/00/Brutalismo.jpg" alt="Brutalismo" style="max-width: 100%; max-height: 32vh; object-fit: contain; border-radius: 8px;">
</div>
</div>
...
<div class="fragment">
<img src="./img/00/DarkMode.jpg" alt="Dark Mode" style="max-width: 100%; max-height: 32vh; object-fit: contain; border-radius: 8px;">
</div>
</div>
...
<div class="fragment">
<img src="./img/00/Microinteracciones.png" alt="Microinteracciones" style="max-width: 100%; max-height: 32vh; object-fit: contain; border-radius: 8px;">
</div>
</div>
...
<div class="fragment">
<strong>Motion Design</strong><br>
Movimiento en las interfaces para guiar la atención, feedback, personalidad...
</div>
<div class="fragment">
<img src="./img/00/MotionDesign.gif" alt="Motion Design" style="max-width: 100%; max-height: 32vh; object-fit: contain; border-radius: 8px;">
</div>
</div>
...
<div class="fragment">
<img src="./img/00/DiseñoInclusivo.png" alt="Diseño inclusivo" style="max-width: 100%; max-height: 32vh; object-fit: contain; border-radius: 8px;">
</div>
</div>
...
<div class="fragment">
<strong>IA en Interfaces</strong><br>
La inteligencia artificial está transformando el desarrollo de interfaces en múltiples frentes. Herramientas como v0.dev o Galileo AI generan interfaces completas a partir de descripciones textuales. GitHub Copilot y similares asisten en la escritura de código de interfaz
</div>
<div class="fragment">
Preguntas sobre el rol futuro del desarrollador de interfaces (¿seguiremos escribiendo HTML y CSS manualmente dentro de cinco años?) que debéis considerar críticamente.
</div>
</div>
...
<span class="fragment">**Framework completo** mantenido por Google</span>
...
<div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 0.7rem; font-size: 1.5rem; text-align: left;">
...
graph TD
    ...
    style DI fill:#000000,stroke:#1565c0,stroke-width:4px
```
